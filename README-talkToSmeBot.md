...
3. Give the bot a handle (ex: `talkToSmeBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://talktosme-dev.azurewebsites.net/api/messages`
